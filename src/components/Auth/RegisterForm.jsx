    ...
    <div className="min-h-screen bg-gradient-to-br from-primary/5 to-secondary/5 flex items-center justify-center px-4 py-8">
      <div className="w-full max-w-2xl">
        <div className="text-center mb-8">
          ...
          <h1 className="text-3xl font-bold text-foreground mb-2">Join HealthCare+</h1>
            ...
            <form onSubmit={handleRegister} className="space-y-6">
              ...
              <div className="space-y-2">
                ...
                <Select value={userType} onValueChange={(value) => setUserType(value)}>
                  ...
                  <SelectContent>
                    <SelectItem value="patient">Patient - Access your health records</SelectItem>
                    <SelectItem value="doctor">Doctor - Manage your patients</SelectItem>
